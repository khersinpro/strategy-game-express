...
class Village extends Model {
    ...
    /**
     * Initializes associations for the Village model
    ...
    /**
     * Find an empty position into the map with parameters and add the village to it
